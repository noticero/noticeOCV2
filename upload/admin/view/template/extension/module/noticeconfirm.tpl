      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-envelope-o"></i> Message Templates
            <button type="button" id="btn-load-templates" class="btn btn-sm btn-info pull-right" style="margin-top:-4px">
              <i class="fa fa-refresh"></i> Load templates from notice.ro
            </button>
          </h3>
        </div>
        <div class="panel-body">
